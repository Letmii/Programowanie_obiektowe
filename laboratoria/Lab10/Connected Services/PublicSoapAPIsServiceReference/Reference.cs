...
namespace PublicSoapAPIsServiceReference
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.dataaccess.com/webservicesserver/", ConfigurationName="PublicSoapAPIsServiceReference.NumberConversionSoapType")]
    public interface NumberConversionSoapType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<PublicSoapAPIsServiceReference.NumberToWordsResponse> NumberToWordsAsync(PublicSoapAPIsServiceReference.NumberToWordsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<PublicSoapAPIsServiceReference.NumberToDollarsResponse> NumberToDollarsAsync(PublicSoapAPIsServiceReference.NumberToDollarsRequest request);
    }
    ...
    public partial class NumberToWordsRequest
    {
        ...
        public PublicSoapAPIsServiceReference.NumberToWordsRequestBody Body;
        
        public NumberToWordsRequest()
        {
        }
        
        public NumberToWordsRequest(PublicSoapAPIsServiceReference.NumberToWordsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToWordsResponse
    {
        ...
        public PublicSoapAPIsServiceReference.NumberToWordsResponseBody Body;
        
        public NumberToWordsResponse()
        {
        }
        
        public NumberToWordsResponse(PublicSoapAPIsServiceReference.NumberToWordsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsRequest
    {
        ...
        public PublicSoapAPIsServiceReference.NumberToDollarsRequestBody Body;
        
        public NumberToDollarsRequest()
        {
        }
        
        public NumberToDollarsRequest(PublicSoapAPIsServiceReference.NumberToDollarsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsResponse
    {
        ...
        public PublicSoapAPIsServiceReference.NumberToDollarsResponseBody Body;
        
        public NumberToDollarsResponse()
        {
        }
        
        public NumberToDollarsResponse(PublicSoapAPIsServiceReference.NumberToDollarsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public interface NumberConversionSoapTypeChannel : PublicSoapAPIsServiceReference.NumberConversionSoapType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public partial class NumberConversionSoapTypeClient : System.ServiceModel.ClientBase<PublicSoapAPIsServiceReference.NumberConversionSoapType>, PublicSoapAPIsServiceReference.NumberConversionSoapType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<PublicSoapAPIsServiceReference.NumberToWordsResponse> PublicSoapAPIsServiceReference.NumberConversionSoapType.NumberToWordsAsync(PublicSoapAPIsServiceReference.NumberToWordsRequest request)
        {
            return base.Channel.NumberToWordsAsync(request);
        }
        
        public System.Threading.Tasks.Task<PublicSoapAPIsServiceReference.NumberToWordsResponse> NumberToWordsAsync(ulong ubiNum)
        {
            PublicSoapAPIsServiceReference.NumberToWordsRequest inValue = new PublicSoapAPIsServiceReference.NumberToWordsRequest();
            inValue.Body = new PublicSoapAPIsServiceReference.NumberToWordsRequestBody();
            inValue.Body.ubiNum = ubiNum;
            return ((PublicSoapAPIsServiceReference.NumberConversionSoapType)(this)).NumberToWordsAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<PublicSoapAPIsServiceReference.NumberToDollarsResponse> PublicSoapAPIsServiceReference.NumberConversionSoapType.NumberToDollarsAsync(PublicSoapAPIsServiceReference.NumberToDollarsRequest request)
        {
            return base.Channel.NumberToDollarsAsync(request);
        }
        
        public System.Threading.Tasks.Task<PublicSoapAPIsServiceReference.NumberToDollarsResponse> NumberToDollarsAsync(decimal dNum)
        {
            PublicSoapAPIsServiceReference.NumberToDollarsRequest inValue = new PublicSoapAPIsServiceReference.NumberToDollarsRequest();
            inValue.Body = new PublicSoapAPIsServiceReference.NumberToDollarsRequestBody();
            inValue.Body.dNum = dNum;
            return ((PublicSoapAPIsServiceReference.NumberConversionSoapType)(this)).NumberToDollarsAsync(inValue);
        }
